...
// start catering
  $('#startNow').click(function () {
    ...
    if (eventDate.val()=='') {
        ...
        returnError = true;
    } else eventDate.removeClass('error');
    ...
    if (numPeople.val()=='') {
        numPeople.addClass('error');
        returnError = true;
    } else numPeople.removeClass('error');
    ...
    //organize the data
    var data = 'name=' + name.val() + '&email=' + email.val() +'&eventDate=' + eventDate.val() + '&number=' + number.val() + '&optradio=' + optradio + '&numPeople=' + numPeople.val();
